describe('SongQueue', function() {
  ...
  describe('when a song ends', function() {
    it('removes the song from the queue', function() {
      ...
      // console.log("coll", songQueue, songQueue.length);
      // console.log("mod", songQueue.models)
      // console.log("trig", songQueue.at(0));
      songQueue.at(0).trigger('ended'); //
      // console.log("collAfter", songQueue)
...
//Chris says this test below is funny - Think about the Event Loop if you run into odd behavior
//where the test fails, despite the website appearing to work propertly
  describe('when a song is dequeued', function() {
    it('removes the song', function() {
      removeSpy = sinon.spy(SongQueue.prototype, 'remove');
      var songQueue = new SongQueue(songData1);
      //console.log("lengthBefore", songQueue.length);
      songQueue.at(0).dequeue();
      //console.log("lengthAfter", songQueue.length);
